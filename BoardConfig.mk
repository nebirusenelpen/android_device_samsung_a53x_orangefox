...
BOARD_USES_FBE_V2 := true

# OrangeFox Recovery: Use TWRP recovery image builder
FOX_USE_TWRP_RECOVERY_IMAGE_BUILDER := true

# OrangeFox Recovery: Device info
OF_MAINTAINER := "YourName"
OF_SCREEN_H := 2400

# OrangeFox Recovery: Additional features
FOX_REPLACE_TOOLBOX_WITH_BUSYBOX := 1
...
# OrangeFox Recovery: Advanced features
OF_ENABLE_LPTOOLS := 1
OF_QUICK_BACKUP_LIST := "/boot;/data;/efs;"
